...
/**
 * Class Reverb_ReverbSync_Helper_Orders_Update_Unpaid
 */
class Reverb_ReverbSync_Helper_Orders_Update_Unpaid extends Reverb_ReverbSync_Helper_Orders_Update_Abstract
{
    /**
     ...
     */
    public function executeMagentoOrderUnpaid($magentoOrder, $reverb_order_status, $orderUpdateArgumentsObject)
    {
