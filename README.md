...
* Sync updates for price/inventory from Magento to Reverb
...
cd /tmp && wget https://github.com/reverbdotcom/magento/archive/0.4.1.tar.gz

# Unzip the release
tar zxvf 0.4.1.tar.gz

# Copy everything from the app folder into your magento app
rsync -avzp magento-0.4.1/app/* $MAGENTO_PATH/htdocs/app/
